...
void print_knobs()
{
    ...
    std::cout << "======= Prefetcher Knob Settings =======" << std::endl;

    std::cout << "coop_enable_multicore: " << knob::coop_enable_multicore << std::endl;
    std::cout << "coop_enable_bw_throttling: " << knob::coop_enable_bw_throttling << std::endl;
    std::cout << "coop_rl_enable: " << knob::coop_rl_enable << std::endl;
    std::cout << "coop_rl_ipc_threshold: " << knob::coop_rl_ipc_threshold << std::endl;
    std::cout << "coop_rl_alpha_high_ipc: " << knob::coop_rl_alpha_high_ipc << std::endl;
    std::cout << "coop_rl_alpha_low_ipc: " << knob::coop_rl_alpha_low_ipc << std::endl;
    std::cout << "coop_rl_bw_threshold: " << knob::coop_rl_bw_threshold << std::endl;
