...
#define LLC_WAY 16
#define LLC_RQ_SIZE 256 // NUM_CPUS*L2C_MSHR_SIZE //48
#define LLC_WQ_SIZE NUM_CPUS*L2C_MSHR_SIZE //48
#define LLC_PQ_SIZE NUM_CPUS*32
#define LLC_MSHR_SIZE 256 // NUM_CPUS*64
...
class CACHE : public MEMORY {
  public:
    ...
    uint64_t pf_requested,
             ...
             pf_useless,
             pf_late;
    // utility methods of CoopPythia prefetcher
	bool check_mshr_hit(uint64_t addr);
	bool check_pq_hit(uint64_t addr);
